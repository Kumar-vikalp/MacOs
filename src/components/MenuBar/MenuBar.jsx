      ...
      <div className="flex items-center gap-1">
        <div className="relative">
          <button
            ...
            className="flex items-center justify-center w-7 h-[20px] rounded-[4px] hover:bg-white/15 transition-colors"
          >
        ...
        <div className="px-2 h-[20px] flex items-center rounded-[4px] hover:bg-white/15 transition-colors cursor-default text-[12.5px] font-medium tracking-tight">
