...
const Window = ({ window, children, isActive }) => {
  ...
  const handleMouseDown = (e) => {
    ...
    const handleMouseMove = (moveEvent) => {
      ...
      newY = Math.max(24, Math.min(newY, viewportHeight - window.height - 80));
  ...
  const containerStyle = {
    ...
    top: isMaximized ? 24 : localPos.y,
  };

  const contentSize = {
    width: isMaximized ? '100vw' : window.width,
    height: isMaximized ? 'calc(100vh - 104px)' : window.height,
  };
        ...
        >
          ...
          <div 
            className={`window-header h-8 flex items-center justify-between px-4 border-b select-none shrink-0 ${
              isActive 
                ? 'bg-linear-to-b from-gray-50/98 to-gray-100/98 border-gray-200/70' 
                : 'bg-linear-to-b from-gray-100/90 to-gray-200/90 border-gray-300/50'
            }`}
          ...
          >
            ...
            <div className={`traffic-lights flex items-center space-x-2 z-50 transition-all duration-200 ${
              ...
              >
                <div className="absolute inset-0 rounded-full bg-linear-to-b from-red-400 to-red-600 shadow-smborder border-red-700/20" />
              ...
              <button
                ...
                style={{ cursor: 'pointer' }}
              >
                <div className="absolute inset-0 rounded-full bg-linear-to-b from-yellow-400 to-yellow-600 shadow-sm border border-yellow-700/20" />
              ...
              <button
                ...
                style={{ cursor: 'pointer' }}
              >
                <div className="absolute inset-0 rounded-full bg-linear-to-b from-green-400 to-green-600 shadow-sm border border-green-700/20" />
