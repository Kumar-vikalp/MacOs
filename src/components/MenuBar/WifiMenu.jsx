...
const WifiMenu = ({ onClose }) => {
  ...
  return (
    <motion.div
      ref={menuRef}
      className="absolute top-[35px] right-2 w-[320px] bg-[#f4f5f5]/80 dark:bg-[#1c1c1e]/80 backdrop-blur-[40px] border border-white/20 dark:border-white/10 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] p-3 text-black dark:text-white"
